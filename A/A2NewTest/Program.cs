...
class Program
{
    ...
    public class Customer : Person
    {
        ...
        public Customer(string id, string name, string phone, int type, string req, string add, double tot) : base(name)
        {
            customerID = id;
            // customerName = name;
    ...
    public class AllReserveration : IReservationable
    {
        ...
        // }
        public void AddReserverationMethod(string CustomerID, string name, string CustomerPhoneNo, int CustomerType, string CustomerCarTypeRequirement, string CustomerAdditionalService, double CustomerTotal)
        {
            customerInfo.Add(new Customer(CustomerID, name, CustomerPhoneNo, CustomerType, CustomerCarTypeRequirement, CustomerAdditionalService, CustomerTotal));
        }
...
{
    Console.WriteLine("Enter a phone number in the format 123-456-7890:");
    ...
    {
        Console.WriteLine("Invalid phone number format. Please use the format 123-456-7890.");
    }
    // CHAR
    if (phoneNumber.Length == 12)
    {
        ...
        if (charArray[3] == '-' && charArray[7] == '-')
        {
            ...
            string formattedNumber = new string(charArray).Replace(" ", "");
    ...
    {
        Console.WriteLine("Invalid phone number length. Please use the format 123-456-7890.");
    }
