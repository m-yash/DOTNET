...
class Program
{
    ...
    class Book
    {
        public void DisplayBookStoreDetails()
        {
            ...
            MyStore.Add("MyBookStore"); MyStore.Add(Fullname); MyStore.Add("SHIBUYA ST, WATERLOO, ON");
    ...
    public class Item : Itemable
    {
        ...
        public void DisplayAllInventory()
        {
            ...
            foreach (ItemDetails i in InvetoryItem)
            {
                try
                {
                    // Not showing Stock value since not mentioned
